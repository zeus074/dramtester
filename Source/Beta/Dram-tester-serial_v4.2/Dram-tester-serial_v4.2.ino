...
//* uncomment this line if you use Display OLED 1306-SSD I2C
// like this : https://www.amazon.it/dp/B0CDLS8F2Y
//if commented, you can use serial monitor @9600 to comunicate with Dram Tester
...
if (digitalRead(M_TYPE)) {
  ...
  delay(5000);
  #else
  Serial.println("DRAMTESTER 4.2 BY RETROFIXER");
  Serial.println("");
  #endif
  selector=selchip();
  l_sel=selector;
...
void startTest() {
   ...
   switch (selector) {
    ...
    case 1:
      ...
      #else
      if (mode == 1) Serial.print("(64k)");
      if (mode == 2) Serial.print("(32k Low)");
      if (mode == 3) Serial.print("(32k High)");
      #endif
   }
