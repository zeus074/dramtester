...
void error(int r, int c)
{
  ...
  String mhex = String(a,HEX);
   ...
   u8g2.sendBuffer();
   #else
   Serial.print("* Erron on ");
   Serial.println((char*)mhex.c_str() );
...
void setDisp() {
   ...
   switch (selector) {
    case 0:
    Serial.println("RAM Sel.: OFF");
    break;
    case 2:
    Serial.println("RAM Sel.: 4116 16k");
    break;
    case 1:
    if (mode == 0) Serial.println("RAM Sel.: 256Kx1");
    if (mode == 1) Serial.println("64Kx1");
    if (mode == 2) Serial.println("32Kx1 L");
    if (mode == 3) Serial.println("32Kx1 H");
   }
   #endif 
}
...
void resDisp (String ntest) {
   ...
   switch (selector) {
    ...
    case 1:
    if (mode == 0) Serial.println("RAM Sel.: 256Kx1");
    if (mode == 1) Serial.println("RAM Sel.: 64Kx1");
    if (mode == 2) Serial.println("RAM Sel.: 32Kx1 Low");
    if (mode == 3) Serial.println("RAM Sel.: 32Kx1 High");
   }
    #endif
}
